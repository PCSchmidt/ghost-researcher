...
Expected current result: 104 backend tests pass, 5 live smoke tests skipped.
...
service fails fast with a clear preflight error. Run the command from Railway
or another environment that can resolve the internal `cloakbrowser.railway.internal` hostname.
