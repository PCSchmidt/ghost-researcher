...
/**
 * Interactive permalink view. The route's page.tsx is a server component
 * (so social crawlers get real Open Graph tags); this child owns the
 * client-side fetch, loading states, and the print-to-PDF button.
 */
export function ReportPermalinkView({ id }: { id: string }) {
